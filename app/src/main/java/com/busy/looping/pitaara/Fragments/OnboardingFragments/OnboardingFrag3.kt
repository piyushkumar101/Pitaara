...
class OnboardingFrag3 : Fragment() {
    var _binding: FragmentOnboardingFrag3Binding?=null
    ...
    override fun onCreateView(
        ...
        _binding= FragmentOnboardingFrag3Binding.inflate(layoutInflater, container, false)
        binding?.fab?.setOnClickListener {
            activity?.supportFragmentManager?.beginTransaction()?.replace(R.id.OnBoardingFrgementView,OnboardingFrag4())?.commitNow()
        }
       return binding?.root
    }
